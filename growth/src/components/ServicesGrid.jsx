      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
            ...
            <p className="text-gray-600 leading-relaxed">Scalable paid acquisition across platforms.</p>
          </div>
          <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
            <div className="text-4xl font-black text-[#FD5800]/20 mb-6 group-hover:text-[#FD5800] transition-colors">02</div>
            <h3 className="text-2xl font-bold text-gray-900 mb-4">SEO & SEM</h3>
            <p className="text-gray-600 leading-relaxed">Dominating search intent and organic traffic.</p>
          </div>
          <div className="bg-white p-10 rounded-3xl shadow-sm hover:shadow-xl transition-all duration-300 border border-gray-100 group">
            <div className="text-4xl font-black text-[#FD5800]/20 mb-6 group-hover:text-[#FD5800] transition-colors">03</div>
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Retention Strategies</h3>
            <p className="text-gray-600 leading-relaxed">Maximizing LTV through email and SMS flows.</p>
          </div>
        </div>
      </div>
    </section>
