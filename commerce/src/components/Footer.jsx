  ...
  return (
    <footer className="bg-[#111111] text-white pt-16 pb-8 font-sans border-t border-black">
      <div className="max-w-[1024px] mx-auto w-full px-16 xl:px-0">
        ...
        {/* Top Huge Typography */}
        <div className="mb-12">
          <h2 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.0] tracking-tight" style={{ fontFamily: "'Urbanist', sans-serif" }}>
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-[#2a2a2a] mb-10"></div>
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 relative">
          ...
          <div className="lg:w-5/12 flex flex-col items-start">
            ...
            <p className="text-gray-300 text-base leading-snug mb-6 max-w-md">
            ...
            <a href="#" className="inline-block bg-[#FD5800] text-white font-semibold py-2.5 px-5 text-xs rounded-full hover:bg-[#e04800] transition-colors">
              Send your URL →
            </a>
          </div>
        ...
        {/* Divider */}
        <div className="w-full h-[1px] bg-[#2a2a2a] mt-12 mb-6"></div>

        {/* Bottom Bar */}
        <div className="flex flex-col md:flex-row justify-between items-center gap-3 text-[#555] text-[9px] tracking-widest font-mono uppercase">
