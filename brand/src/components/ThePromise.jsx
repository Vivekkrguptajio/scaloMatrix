  ...
  return (
    <section className="w-full bg-white text-black py-8 md:py-12 lg:py-14 font-sans flex flex-col items-center justify-center px-6 text-center rounded-b-[40px] md:rounded-b-[60px]">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        <h4 className="text-transparent bg-clip-text bg-gradient-to-r from-[#FD5800] to-violet-500 text-[10px] md:text-xs font-bold tracking-[0.2em] uppercase mb-6">
          The Promise
        </h4>
        
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-black tracking-tight mb-8 leading-[1.1]">
          <span className="text-black">Pages that earn their keep</span><br className="hidden md:block" />
          <span className="text-[#FD5800]">— or we keep working.</span>
        </h2>
        ...
        <a 
          href="#contact" 
          className="group inline-flex items-center justify-center gap-2 bg-gradient-to-r from-[#FD5800] to-violet-500 text-white font-bold py-4 px-8 rounded-full border border-transparent hover:scale-105 hover:from-transparent hover:to-transparent hover:bg-transparent hover:text-black hover:border-black transition-all duration-300 shadow-lg hover:shadow-xl"
        >
          Request your audit
