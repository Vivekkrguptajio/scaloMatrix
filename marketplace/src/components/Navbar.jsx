      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="https://commerce-scaolmatrix.onrender.com" className="text-brand-text hover:text-brand-accent transition-colors font-medium">Commerce</a>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-brand-surface border-t border-brand-surface-hover shadow-xl">
          <div className="px-4 pt-2 pb-6 space-y-4 flex flex-col">
            ...
            <a href="https://commerce-scaolmatrix.onrender.com" className="block px-3 py-2 text-brand-text hover:text-brand-accent font-medium">Commerce</a>
