  ...
  Solutions: {
    ...
    columns: [
      ...
      },
      {
        title: 'COMMERCE',
        items: [
          { title: 'Shopify Development', href: import.meta.env.VITE_COMMERCE_URL || 'http://commerce.localhost:5173' },
          { title: 'Marketplace', href: import.meta.env.VITE_MARKETPLACE_URL || 'http://marketplace.localhost:5174' },
          { title: 'Finance', href: '#' },
