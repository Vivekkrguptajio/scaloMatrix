...
export default function About() {
  return (
    <section id="about" className="w-full flex justify-center items-center p-4 md:p-6 font-sans">
      ...
      <div className="w-full border-[2px] md:border-[3px] border-[#FF4500] rounded-[30px] md:rounded-[50px] p-6 md:p-10 lg:p-12 flex flex-col gap-6 md:gap-8 bg-[#FF4500]">
        
        {/* Inner Centered Container */}
        <div className="max-w-5xl w-full mx-auto flex flex-col gap-6 lg:gap-8 flex-grow justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-4 w-full max-w-4xl mx-auto">
            ...
            <motion.div 
              ...
              <motion.ul 
                ...
                className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm lg:text-base text-gray-700 font-medium mt-6 relative z-10">
