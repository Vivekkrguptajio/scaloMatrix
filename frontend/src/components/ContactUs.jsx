...
export default function ContactUs() {
  ...
  return (
    <section className="relative w-full min-h-[100svh] flex flex-col justify-center pt-16 pb-24 md:pt-24 md:pb-28 bg-white font-sans overflow-hidden rounded-b-[20px] md:rounded-b-[40px]">
